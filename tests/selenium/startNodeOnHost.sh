...
scp -i id_rsa_zorroa_selenium_node -o StrictHostKeyChecking=no startNode.sh stopNode.sh zorroa@$HOST:~/Desktop/selenium/
ssh -i id_rsa_zorroa_selenium_node -o StrictHostKeyChecking=no zorroa@$HOST "cd ~/Desktop/selenium; ./startNode.sh"
