...
scp -i id_rsa_zorroa_selenium_node -o StrictHostKeyChecking=no stopNode.sh "zorroa@$HOST:~/Desktop/selenium/"
ssh -i id_rsa_zorroa_selenium_node -o StrictHostKeyChecking=no zorroa@$HOST "cd ~/Desktop/selenium; ./stopNode.sh"
