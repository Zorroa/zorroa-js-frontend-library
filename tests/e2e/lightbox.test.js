...
describe('Lightbox', function () {
  ...
  it('check lightbox', function () {
    ...
    .then(_ => selenium.expectSelectorEnabledToBe(false, By.css('.Controlbar__zoom-reset')))
    .then(_ => selenium.clickSelector(By.css('.Controlbar__zoom-in')))
    .then(_ => selenium.waitForSelectorEnabledToBe(true, By.css('.Controlbar__zoom-reset')))
    .then(_ => selenium.clickSelector(By.css('.Controlbar__zoom-reset')))
    .then(_ => selenium.waitForSelectorEnabledToBe(false, By.css('.Controlbar__zoom-reset')))
    .then(_ => selenium.clickSelector(By.css('.Controlbar__zoom-out')))
    .then(_ => selenium.waitForSelectorEnabledToBe(true, By.css('.Controlbar__zoom-reset')))
