  ...
  <div className="TableLayoutHelp">
    ...
    <div className="TableLayoutHelp-sections">
      <div className="TableLayoutHelp-section">
        ...
        <div className="TableLayoutHelp-body">
          ...
          <ol className="TableLayoutsHelp-list">
            <li>
              Click the gear icon and look up a column you want to add.
              <br />
              <i>Columns are the same as metadata fields.</i>
            </li>
      ...
      <div className="TableLayoutHelp-section">
        ...
        <div className="TableLayoutHelp-body">
          <div>
            Right-click on a column name and select one of the order items
          </div>
        </div>
      </div>
      <div className="TableLayoutHelp-section">
        ...
        <div className="TableLayoutHelp-body">
          <div>
            Click and drag the bar between two columns in the header to resize
            columns
          </div>
        </div>
      </div>
      <div className="TableLayoutHelp-section">
        ...
        <div className="TableLayoutHelp-body">
          <div>
            Layouts with the locked icon cannot be edited, but you can duplicate
            them and then edit a copy.
          </div>
        </div>
      </div>
      <div className="TableLayoutHelp-section">
    ...
    <div className="TableLayoutHelp-footer">
      <div className="TableLayoutHelp-button" onClick={dismissFp}>
        Got It!
      </div>
    </div>
  </div>
