...
const tips = [
  ...
  <div>You can check the status of imports or add more cloud services, servers, or files from your computer from the Imports menu at the top of the screen. It will display <img className="ImportingTip-tip-img" src={ellipsis}/> until analysis is done.</div>,
...
const ImportingTip = (props) => (
  <div className="ImportingTip">
    <div className="ImportingTip-title">
      Your assets are importing!
    </div>
    ...
    <div className="ImportingTip-dismiss">
      <div onClick={props.onDismiss} className="ImportingTip-dismiss-button disabled">
        Dismiss
      </div>
    </div>
  </div>
