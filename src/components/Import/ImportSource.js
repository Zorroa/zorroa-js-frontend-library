...
const ImportSource = props => (
  <div className="ImportSource">
    ...
    <div className="Import-title">
      <div className="Import-step">Step 1:</div> Where is your stuff?*
    </div>
    <div className="ImportSource-subtitle">
      * Your assets will stay exactly where they are. Zorroa will take a
      snapshot<br />
        ...
        <div key={source} className="ImportSource-location">
              ...
              <div className="ImportSource-cloud-services">
                {services.map((service, i) => (
                  <img
                    key={service}
                    src={serviceIcons[i]}
                    className="ImportSource-cloud-service"
                    onClick={e => props.onSelect(service, e)}
                  />
                ))}
              </div>
            )}
          ...
          <div className="ImportSource-location-overlay">
            <div
              ...
              onClick={e => props.onSelect(source, e)}>
              {sourceTags[i]}
            </div>
          </div>
        </div>
