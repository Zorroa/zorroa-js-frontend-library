        ...
        <div className="Expando-header">
          ...
          <div className="Expando-item-script-info">
            ...
            <div
              ...
              className={classnames('Expando-item-script-info-state', {
                showInfo,
              })}>
              {showInfo ? 'ON' : 'OFF'}
            </div>
        ...
        <div className="Expando-body">
          {filteredItems
            ? filteredItems.map(item => (
                <div
                  key={item.id}
                  className={classnames('Expando-item', {
                    isSelected: item.id === itemId,
                  })}>
                  <div
                    onClick={!showInfo && (e => this.selectItem(item, e))}
                    className={classnames('Expando-item-header', { showInfo })}>
                    <div className="Expando-item-title">
                      <div className="icon-script" />
                      <div className="Expando-item-name">{item.name}</div>
                    </div>
                  </div>
                  <div
                    className={classnames('Expando-item-body', { showInfo })}>
                    <div className="Expando-item-info">{item[infoField]}</div>
                    <div
