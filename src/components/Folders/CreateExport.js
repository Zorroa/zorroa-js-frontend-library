      ...
      <div className="CreateExport">
        <div className="header">
          ...
          <div
            ...
            className="CreateExport-close icon-cross"
          />
        </div>
        <div className="body flexCol">
          ...
          <div className="CreateExport-package-name">
            ...
            <div
              ...
              className="CreateExport-package-name-cancel icon-cancel-circle"
            />
          </div>
          <div className="option-row">
            <input
              type="checkbox"
              checked={this.state.exportImages}
              onChange={this.toggleExportImages}
            />
            <div className="CreateExport-input-label">
              <div className="CreateExport-input-text">
                Export original assets.
              </div>
              <div className="CreateExport-subtext">
                Full size, original file type.
              </div>
            </div>
          </div>
          <div className="option-row">
            <input
              type="checkbox"
              checked={this.state.exportTable}
              onChange={this.toggleExportTable}
            />
            <div className="CreateExport-input-label">
              <div className="CreateExport-input-text">
                Export current metadata table
              </div>
          ...
          <div className="option-row">
            <input
              disabled={true}
              type="checkbox"
              checked={this.state.exportContactSheet}
              onChange={this.toggleExportContactSheet}
            />
            <div className="CreateExport-input-label">
              <div className="CreateExport-input-text">
                Export contact sheet (TBD)
              </div>
        ...
        <div className="footer">
          <button
            onClick={!isDisabled && this.create}
