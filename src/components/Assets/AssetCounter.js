...
const AssetCounter = (props) => (
  <div className="asset-counter">
    <span className="asset-counter-count asset-counter-loaded">{props.loaded - props.collapsed}</span>
    <span className="asset-counter-of"></span>
    <span className="asset-counter-count asset-counter-total">{props.total}</span>
