...
class AddWidget extends Component {
  ...
  static widgetInfos = (widgets, filterText, permissions) => {
    ...
    const singletonTypes = new Set([
      ...
      WidgetInfo.CollectionsWidgetInfo.type,
      WidgetInfo.MultipageWidgetInfo.type,
      WidgetInfo.ImportSetWidgetInfo.type,
    ])
      ...
      <div className="AddWidget">
          ...
          <div className="filter">
            <div className="filter-input">
              ...
              <div
                ...
                className={classnames('icon-cancel-circle', { isEmptyFilter })}
              />
            </div>
        ...
        <div className="body">
          <div className="search-info">
            <label htmlFor="showDescription" className="search-info-label">
              Show Search Information
            </label>
            <Toggle
              checked={showDescriptions}
              onChange={this.toggleShowDescriptions}
            />
            <div className="text-val">{showDescriptions ? 'On' : 'Off'}</div>
          </div>
          <div className="widget-grid">
            {AddWidget.widgetInfos(widgets, filterText, permissions).map(
              widgetInfo => (
                <div
                  className={`widget widget-${widgetInfo.type}`}
                  key={widgetInfo.type}>
                  <div
                    className="title-bar"
                    ...
                    onClick={
                      showDescriptions
                        ? null
                        : this.addWidget.bind(this, widgetInfo)
                    }>
                  ...
                  {showDescriptions ? (
                    <div className="widget-description">
                      ...
                      <button
                        onClick={this.addWidget.bind(this, widgetInfo)}
                        style={{ backgroundColor: widgetInfo.color }}
...
export default connect(
  ...
  dispatch => ({
    actions: bindActionCreators(
      { modifyRacetrackWidget, showModal, hideModal },
      dispatch,
    ),
  }),
)(AddWidget)
