...
class Settings extends Component {
  ...
  scroll = event => {
    ...
    )[0].style.left = `-${event.target.scrollLeft}px`
  }
  ...
  changeSetting = (event, setting) => {
    ...
    if (
      event.target.value === setting.currentValue &&
      modifiedValues[setting.name]
    )
      delete modifiedValues[setting.name]
  ...
  render() {
    ...
    const filterSetting = setting =>
      ...
      (setting.name.toLowerCase().includes(lcFilter) ||
        ...
        (setting.description &&
          setting.description.toLowerCase().includes(lcFilter)))
    ...
    return (
      <div className="Settings">
        ...
        <div className="Settings-body">
            ...
            <div className="Settings-filter-controls">
              ...
              <div className="Settings-show-live">
                <input
                  ...
                  onChange={this.toggleShowLive}
                />
                <div className="Settings-show-live-label">
                  Only Show Editable Settings
                </div>
              </div>
            </div>
          ...
          <div className="Settings-table-header">
            <div
              ...
              style={{ minWidth: columnWidth.name }}>
              Name
            </div>
            <div
              className="Settings-column"
              style={{ minWidth: columnWidth.category }}>
              Category
            </div>
            <div
              className="Settings-column"
              style={{ minWidth: columnWidth.currentValue }}>
              Value
            </div>
            <div
              className="Settings-column"
              style={{ minWidth: columnWidth.defaultValue }}>
              Default
            </div>
            <div
              className="Settings-column"
              style={{ minWidth: columnWidth.description }}>
              Description
            </div>
          </div>
          <div
            className="Settings-settings"
            ref="SettingsSettings"
            ...
            {settings &&
              Object.keys(settings)
                ...
                .map(setting => (
                  <div
                    className={classnames('Settings-setting', {
                      live: setting.live,
                    })}
                    key={setting.name}>
                    <div
                      className="Settings-setting-name"
                      style={{ minWidth: columnWidth.name }}
                      title={setting.name}>
                      {setting.name}
                    </div>
                    <div
                      className="Settings-setting-category"
                      style={{ minWidth: columnWidth.category }}
                      title={setting.category}>
                      {setting.category}
                    </div>
                    <textarea
                      className="Settings-setting-value"
                      style={{ minWidth: columnWidth.currentValue }}
                      disabled={!setting.live}
                      value={
                        modifiedValues[setting.name] !== undefined
                          ? modifiedValues[settings.name]
                          : setting.currentValue
                      }
                      title={setting.currentValue}
                      onChange={e => this.changeSetting(e, setting)}
                    />
                    <div
                      className="Settings-setting-default"
                      style={{ minWidth: columnWidth.defaultValue }}
                      title={setting.defaultValue}>
                      {setting.defaultValue}
                    </div>
                    <div
                      className="Settings-setting-description"
                      style={{ minWidth: columnWidth.description }}
        ...
        <div className="Settings-footer">
          <div
            className={classnames('Settings-save', { disabled: !canSave })}
            onClick={canSave ? this.save : null}>
            Save
          </div>
          <div className="Settings-cancel" onClick={this.close}>
            Cancel
          </div>
        </div>
      </div>
