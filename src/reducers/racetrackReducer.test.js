...
describe('racetrackReducer', () => {
  it('MODIFY_RACETRACK_WIDGET returns modified widget', () => {
    ...
    const widget = new Widget({ sliver, type: widgetTypes.SIMPLE_SEARCH_WIDGET })
  ...
  it('REMOVE_RACETRACK_WIDGET_IDS returns smaller widgets', () => {
    ...
    const widget1 = new Widget({ sliver: sliver1, type: widgetTypes.SIMPLE_SEARCH_WIDGET })
    const widget2 = new Widget({ sliver: sliver2, type: widgetTypes.SIMPLE_SEARCH_WIDGET })
  ...
  it('RESET_RACETRACK_WIDGETS to replace initial state', () => {
    ...
    const widget1 = new Widget({ sliver: sliver1, type: widgetTypes.SIMPLE_SEARCH_WIDGET })
    const widget2 = new Widget({ sliver: sliver2, type: widgetTypes.SIMPLE_SEARCH_WIDGET })
    const widget3 = new Widget({ sliver: sliver3, type: widgetTypes.SIMPLE_SEARCH_WIDGET })
    const initialState = { widgets: [ widget1, widget2 ] }
