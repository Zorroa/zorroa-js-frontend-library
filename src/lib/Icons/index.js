...
export function CancelCircle() {
  return (
    <svg
      ...
      <defs>
        <path
          d="M7.5 0a7.5 7.5 0 1 0 0 15 7.5 7.5 0 0 0 0-15zm3.75 9.844L9.844 11.25 7.5 8.906 5.156 11.25 3.75 9.844 6.094 7.5 3.75 5.156 5.156 3.75 7.5 6.094 9.844 3.75l1.406 1.406L8.906 7.5l2.344 2.344z"
          id="a"
        />
      </defs>
...
export class Gauge extends PureComponent {
  ...
  startAnimation = (
    ...
    requestAnimationFrame(() => {
      ...
      const percentComplete = ease.outBounce(
        delta / animationDurationMilliseconds,
      )
      const finalRotationDegrees = this.availableRotateDegrees[intensity]
      const oldRotationDegrees = this.availableRotateDegrees[
        this.state.oldIntensity
      ]
      ...
      this.setState({
        rotateDegrees:
          percentComplete * (finalRotationDegrees - oldRotationDegrees) +
          oldRotationDegrees,
      })
...
export function Flipbook() {
  return (
    <svg
      ...
      <defs>
        <path
          d="M8.5 3.1s-2.1-2-8.5-2v12.7c6.4 0 8.5 2 8.5 2s2-2 8.5-2V1c-6.4 0-8.5 2.1-8.5 2.1zm-6.4 0c2.7.3 4.4.9 5.3 1.4v8.6c-1-.5-2.6-1.2-5.3-1.4V3.1zM15 11.7c-2.7.2-4.4.9-5.3 1.4V4.5c1-.5 2.6-1.1 5.3-1.4v8.6z"
          id="c"
        />
      </defs>
      <g fill="none" fillRule="evenodd">
  ...
  return (
    <svg
      ...
      <defs>
        <path
          id="e"
          d="M12.3 0H2C.9 0 0 .8 0 1.9V13c0 1 .8 1.9 1.9 1.9H13c1 0 1.9-.8 1.9-1.9V3L12.3 0zm-1 5.6c0 .5-.5 1-1 1H4.7a1 1 0 0 1-1-1V1h7.5v4.7zm-1-3.7H8.4v3.7h2V2z"
        />
      </defs>
      <g fill="none" fillRule="evenodd">
        <mask id="f" fill="#fff">
